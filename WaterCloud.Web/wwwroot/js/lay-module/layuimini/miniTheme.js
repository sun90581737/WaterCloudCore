            ...
            var bgColorConfig = [
                {
                    ...
                    headerLogoBg: '#333333', //logo背景颜色,
                    headerLogoColor: 'rgb(191, 187, 187)', //logo字体颜色,
                    leftMenuNavMore: 'rgb(191, 187, 187)', //左侧菜单更多下拉样式,
                    leftMenuBg: '#333333', //左侧菜单背景,
                    leftMenuBgThis: '#f3961d', //左侧菜单选中背景,
                    leftMenuChildBg: '#58462f', //左侧菜单子菜单背景,
                    leftMenuColor: 'rgb(191, 187, 187)', //左侧菜单字体颜色,
                    leftMenuColorThis: '#ffffff', //左侧菜单选中字体颜色,
                    tabActiveColor: '#f3961d', //tab选项卡选中颜色,
                },
                {
        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    //'<a class="more-menu-item" href="http://www.baidu.com/#/" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i> 开发文档</a>\n' +
                    //'<a class="more-menu-item" href="https://www.baidu.com" target="_blank"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i> 开源地址</a>\n' +
                    //'<a class="more-menu-item" href="http://www.baidu.com/" target="_blank"><i class="layui-icon layui-icon-theme"></i> 演示地址</a>\n' +
                    //'</div>' +
                    '</div>';
                layer.open({
                    type: 1,
