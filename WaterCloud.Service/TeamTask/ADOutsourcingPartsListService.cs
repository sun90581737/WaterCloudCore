...
{
    public class ADOutsourcingPartsListService : DataFilterService<ADOutsourcingPartsListEntity>, IDenpendency
    {
        public ADOutsourcingPartsListService(IDbContext context) : base(context)
        {
        }
        public async Task<List<ADOutsourcingPartsListEntity>> GetList(Pagination pagination, string keyvalue)
        {
            ////获取数据权限
