...
{
    public class ADAbnormalProportionService : DataFilterService<ADAbnormalProportionEntity>, IDenpendency
    {
        public ADAbnormalProportionService(IDbContext context) : base(context)
        {
        }
        public async Task<List<ADAbnormalProportionEntity>> GetList(Pagination pagination, string keyvalue)
        {
            ////获取数据权限
