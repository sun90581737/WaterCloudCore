...
{
    public class DataAcquisitionDetailMySqlService : RepositoryBase, IDataAcquisitionDetailService
    {
        public DataAcquisitionDetailMySqlService(IDbContext context) : base(context)
        {
        ...
        public async Task<List<DataAcquisitionDetailEntity>> GetTableFieldList(string ConfTime)
        {
            ...
            strSql.Append(@"SELECT * FROM  watercloudnetdb.Sys_DataAcquisitionDetail 
