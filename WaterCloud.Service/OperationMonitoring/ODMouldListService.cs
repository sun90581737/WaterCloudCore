...
{
    public class ODMouldListService : DataFilterService<ODMouldListEntity>, IDenpendency
    {
        public ODMouldListService(IDbContext context) : base(context)
        {
        }
        public async Task<List<ODMouldListEntity>> GetList(Pagination pagination, string keyvalue)
        {
            ////获取数据权限
